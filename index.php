        ...
        <div class="nav">
            <div class="container">
                ...
                <ul>
                    ...
                    <li>
                        <a class="button" href="#">Aanmelden <i class="material-icons">navigate_next</i></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="AlleHuizen">
            <div class="container">
                <div class="land">
                    ...
                    <p>Specifiek op zoek naar een van onze vakantieparken? Voor u heeft Happy Home Holidays meer dan 134 vakantieparken op volgorde van locatie gezet. Zo kan u dus heel erg eenvoudig uw gewenste park vinden, vergelijken en boeken.</p>
                </div>
                <div class="land">
                    <h3>Duitsland</h3>
                    <ul>
